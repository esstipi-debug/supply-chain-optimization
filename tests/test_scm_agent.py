...
def test_build_default_registry_tools():
    ...
    assert keys == {"inventory_optimization", "pricing", "leadership_chain", "cost_to_serve", "sop", "abc_xyz", "sourcing", "ddmrp", "landed_cost", "whatif", "financial_kpis", "reconciliation", "returns", "warehouse_layout", "queuing", "scheduling", "risk", "forecast", "data_quality", "dea", "acceptance_sampling", "earned_value", "learning_curve", "odoo_replenishment", "newsvendor", "cycle_count", "multi_echelon"}
